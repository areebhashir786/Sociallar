                    ...
                    <div className='DialogBox'>
                        ...
                        <form className='commentForm' onSubmit={addCommentHandler}>
                            <input
                                ...
                                required
                            />
                            <Button type='submit' variant="contained" color="info" onClick={addCommentHandler}><SendIcon /></Button>
                        </form>
                    ...
                    <div className='DialogBox'>
                        ...
                        <form action='' className='commentForm' onSubmit={updateCaptionHandler}>
                            <input
                                ...
                                placeholder="Coption Here..."
                                required
                            />
                            <Button type='submit' variant="contained" color="info" onClick={updateCaptionHandler}><SendIcon /></Button>
                        </form>
                    </div>
                </Dialog>
            </div>
